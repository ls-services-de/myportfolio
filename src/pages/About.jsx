...
const About = () => {
  return (
    <section className='max-container'>
      <h1 className='head-text'>Hello, I'm <span className='blue-gradient_text font-semibold drop-shadow'>Liam</span></h1>
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>Website Developer based in Germany, specializing in Ecommerce Plattforms with Payment Integration and APIs. </p>
      </div>
